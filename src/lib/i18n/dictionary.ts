...
const dictionaries = {
  tr: {
    ...
    "products.intro":
      "Duosis'in geliştirdiği ürünler. Her biri farklı bir operasyon problemini çözer; hepsi aynı mühendislik disipliniyle kurulur.",
    "products.all": "Tüm ürünler",
    "products.inDevelopment": "Geliştirme aşamasında",
    "products.whatItSolves": "Hangi problemi çözüyor?",
    "products.inputs": "Sisteme ne giriyor?",
    "products.mechanism": "Ürün ne yapıyor?",
    "products.outcomes": "Kullanıcı ne görüyor?",
    "products.capabilities": "Yetenekler",
    "products.workflow": "Nasıl çalışır?",
    "products.security": "Güvenlik ve sınırlar",
  ...
  en: {
    ...
    "products.intro":
      "The products Duosis builds. Each one solves a different operations problem; all of them are built with the same engineering discipline.",
    "products.all": "All products",
    "products.inDevelopment": "In development",
    "products.whatItSolves": "What problem does it solve?",
    "products.inputs": "What goes in?",
    "products.mechanism": "What does the product do?",
    "products.outcomes": "What does the user see?",
    "products.capabilities": "Capabilities",
    "products.workflow": "How it works",
    "products.security": "Security and boundaries",
    "products.audiences": "Who is it for?",
